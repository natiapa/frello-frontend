...
export function TaskChecklist({ checklists, onUpdated = () => {}, task }) {
                    ...
                    updatedChecklists.map(checklist => (
                        <li className="checklist" key={checklist.id}>
                            <div className="header-and-btns">
                                ...
                                <button
                                    onClick={ev =>
                                        onRemoveChecklist(ev, checklist.id)
                                    }>
                                    Delete
                                </button>
                            </div>
                            ...
                            {isAddingItem && checklist.isAddingItem && (
                                <div>
                                    ...
                                    <button
                                        onClick={ev =>
                                            onSaveItem(ev, checklist.id)
                                        }>
                                        Add
                                    </button>
                                    <button
                                        onClick={ev => oncancel(ev, checklist)}>
                                        Cancel
                                    </button>
                                </div>
                            )}
