    ...
    return (
      <>
        ...
        <div className="footer-group">
            {isNewTask && <AddingForm setIsNew={setIsNewTask} setNew={setNewTask} currBoard={currBoard} updateBoard={updateBoard} updated={newTask} groupId={group.id} tasks={group.tasks}/>}
